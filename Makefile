...
cowboy-server: validate
	docker run --rm -e CHOWNUID=${UID} -v `pwd`:/swagger -t ${SWAGGER_COWBOY_SERVER_IMAGE} generate -Dapis -DapiFileNameSuffix="_rest_routes" -i ./swagger.json -l cowboy -o ./generated/cowboy
	./fix_generated.py
